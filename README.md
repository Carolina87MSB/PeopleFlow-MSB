...
- **`peopleflow_pdi`** — ainda só estrutura de dados (repositório só lê, `getPdi()`) — geração automática a partir de avaliações fica pra próxima etapa.
